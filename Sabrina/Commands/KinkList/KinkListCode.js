        ...
        inputKinks = {
                ...
                createColumns: function () {
                        ...
                        for (var i = 0; i < numCols; i++) {
                                inputKinks.$columns.push($("<div>").addClass("col " + colClass)
                                        .appendTo($("#InputList")));
                        }
                },
                ...
                fillInputList: function () {
                        ...
                        $("#InputList").find("button.choice").on("click",
                                function () {
                ...
                parseHash: function () {
                        //D var hash = location.hash.substring(1);
                        //D if (hash.length < 10) return;

                        //D var values = inputKinks.decode(Object.keys(colors).length, hash);
                        //D var valueIndex = 0;
                        $("#InputList .choices").each(function () {
                                var $this = $(this);
        ...
        (function () {
                ...
                inputKinks.inputPopup = {
                        ...
                        showIndex: function (index) {
                                ...
                                $field.text((currentKink.showField ? "(" + currentKink.field + ") " : "") +
                                        currentKink.kink);
                                $options.append($currentKink);
